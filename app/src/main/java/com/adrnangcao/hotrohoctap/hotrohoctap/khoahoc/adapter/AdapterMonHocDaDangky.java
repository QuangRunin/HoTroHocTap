...
public class AdapterMonHocDaDangky extends BaseAdapter {
    public AdapterMonHocDaDangky(int layout, MonHocDaDangKi_Fragment context, List<MonHoc> list) {
        Layout = layout;
    ...
    DatabaseKhoaHoc db;
    int Layout;
    MonHocDaDangKi_Fragment mContext;
    List<MonHoc> list;
    @Override
    public int getCount() {
        return list.size();
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        db = new DatabaseKhoaHoc(mContext.getActivity());
...
//                            Log.d("", "Delete: "+monHoc.getIDAuto().toString());
                        ...
                        MonHocDaDangKi_Fragment.TenMonHocList.clear();
                        mContext.getMonHoc();
                    }
                });
